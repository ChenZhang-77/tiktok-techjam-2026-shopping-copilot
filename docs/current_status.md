...
| A14-1 runtime/audit source commit | `c6fb8e5`; closed Question Policy diagnostics and ten closed-schema attribute-evidence records per turn with the same visible response |
...
A14-1 is now retained at final runtime/audit source commit `c6fb8e5`. All ten allowed
