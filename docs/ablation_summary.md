...
| B12 bounded adaptive depth | 0.86875 | 0.549735 | 4.60625 | 0.727170 | Exploratory; default off |
...
all four folds. B12 remains optional: it improved aggregate quality but lacked
a contemporaneous gate and produced a small fold-1 regression, two parity
folds, and a material fold-4 gain.
...
CrossEncoder remains a learned reranker rather than an LLM. B10b-DS1/DS2 code
and provisional remote measurements exist, but their complete reports are not
yet hash-bound tracked evidence, so they are intentionally not promoted into
this ablation summary. Neither B10b path is the retained default. Profile
ranking remains disabled at weight 0.0, and A13 A-side semantic understanding
remains plan-only.
